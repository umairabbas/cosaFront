		...
		<div id="containerdsl" class="row containerdsl">
			<div class="col-sm-4 containerdsl" style="padding:5px;background-color:#10192A;" style="overflow-y:scroll;">
				<div class="container-fluid">	
					...
					<form action="/cosa/getDSLResult" method="POST" id="dslform">
			...
			<div class="modal-body">
          		...
          		<div class="tab-content">
          			...
          			<div id="htutable" class="tab-pane fade">
          				...
          				<h4>Structure</h4>
          				<div class="well">
          					<code>&lt;table&gt;</code><sup>1</sup><br/>
          					&emsp;<code>&lt;vcsroot&gt;</code>[vcs local directory]<code>&lt;/vcsroot&gt;</code><sup>1</sup><br/>
          					&emsp;<code>&lt;classname&gt;</code>[classname]<code>&lt;/classname&gt;</code><sup>*</sup><br/>
          					&emsp;<code>&lt;codesmell&gt;</code>[All|God Class|BrainClass|Data Class]<code>&lt;/codesmell&gt;</code><sup>?</sup><br/>
          					&emsp;<code>&lt;change&gt;</code>[All|Strong Active|Stable Active|Ameliorate Active|Dormant]<code>&lt;/change&gt;</code><sup>?</sup><br/>
          					&emsp;<code>&lt;version&gt;</code>[version number]<code>&lt;/version&gt;</code><sup>*</sup><br/>
          					<code>&lt;/table&gt;</code>
          					<br/>
          					<br/>
          					<strong>Explanation:</strong><br/>
          					<sup>1</sup> : needs to be occurred exactly once<br/>
          					<sup>*</sup> : can be occurred once or more<br/>
          					<sup>?</sup> : can be occurred or not (in the absence of this tag, it will automatically select all data)<br/>
          				</div>
          				
          				<h4>Example</h4>
          				<div class="well">
          					<code>&lt;table&gt;</code><br/>
          					&emsp;<code>&lt;vcsroot&gt;</code>/Users/harriskristanto/Desktop/Github Folder/Test/<code>&lt;/vcsroot&gt;</code><br/>
          					&emsp;<code>&lt;classname&gt;</code>CPPParser<code>&lt;/classname&gt;</code><br/>
          					&emsp;<code>&lt;classname&gt;</code>Parser<code>&lt;/classname&gt;</code><br/>
          					&emsp;<code>&lt;codesmell&gt;</code>All<code>&lt;/codesmell&gt;</code><br/>
          					&emsp;<code>&lt;change&gt;</code>Strong Active<code>&lt;/change&gt;</code><br/>
          					<code>&lt;/table&gt;</code>
          				</div>
          			</div>
          			<div id="htulinegraph" class="tab-pane fade">
          				...
          				<h4>Structure</h4>
          				<div class="well">
          					<code>&lt;linegraph&gt;</code><sup>1</sup><br/>
          					&emsp;<code>&lt;vcsroot&gt;</code>[vcs local directory]<code>&lt;/vcsroot&gt;</code><sup>1</sup><br/>
          					&emsp;<code>&lt;classname&gt;</code>[classname]<code>&lt;/classname&gt;</code><sup>+</sup><br/>
          					&emsp;<code>&lt;codesmell&gt;</code>[All|God Class|Brain Class|Data Class]<code>&lt;/codesmell&gt;</code><sup>?</sup><br/>
          					&emsp;<code>&lt;change&gt;</code>[All|Strong Active|Stable Active|Ameliorate Active|Dormant]<code>&lt;/change&gt;</code><sup>?</sup><br/>
          					&emsp;<code>&lt;axis&gt;</code>[Severity Impact|Severity Level|Harmfulness Level|Changes]<code>&lt;/axis&gt;</code><sup>1</sup><br/>
          					<code>&lt;/linegraph&gt;</code>
          					<br/>
          					<br/>
          					<strong>Explanation:</strong><br/>
          					<sup>1</sup> : needs to be occurred exactly once<br/>
          					<sup>+</sup> : needs to be occurred at least once<br/>
          					<sup>*</sup> : can be occurred once or more<br/>
          					<sup>?</sup> : can be occurred or not (in the absence of this tag, it will automatically select all data)<br/>
          				</div>
          				...
          				<h4>Example</h4>
          				<div class="well">
          					<code>&lt;linegraph&gt;</code><br/>
          					&emsp;<code>&lt;vcsroot&gt;</code>/Users/harriskristanto/Desktop/Github Folder/Test/<code>&lt;/vcsroot&gt;</code><br/>
          					&emsp;<code>&lt;classname&gt;</code>CPPParser<code>&lt;/classname&gt;</code><br/>
          					&emsp;<code>&lt;classname&gt;</code>Parser<code>&lt;/classname&gt;</code><br/>
          					&emsp;<code>&lt;codesmell&gt;</code>All<code>&lt;/codesmell&gt;</code><br/>
          					&emsp;<code>&lt;change&gt;</code>Strong Active<code>&lt;/change&gt;</code><br/>
          					&emsp;<code>&lt;axis&gt;</code>Harmfulness Level<code>&lt;/axis&gt;</code><br/>
          					<code>&lt;/linegraph&gt;</code>
          				</div>
          			</div>
          		</div>
		...
		function createLinegraph(data){
			...
			for(var i = 0 ; i < data.resultcontent.version.length; i++){
				...
				for(var j = 0 ; j < data.resultcontent.version[i].length; j++){
					datay[i][j] = data.resultcontent.version[i][j];
				}
			}
